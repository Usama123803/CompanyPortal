		                      	...
		                      	<tbody>
		                      		...
		                      		@foreach($package_codes as $val_CR)
				                        <tr class="align-middle">
				                          	...
				                          	<td>
				                          		<a href="{{ route('company.editPackageCode', ['id' => $val_CR->id]) }}" class="btn btn-primary btn-primary">Edit</a>
				                          		@if($val_CR->reviews->isNotEmpty())
												@else
				                          			<a href="{{ route('company.deletePackageCode', ['id' => $val_CR->id]) }}" class="btn btn-danger btn-danger" onclick="return confirm('Are you sure you want to delete?');">DELETE</a>
				                          		@endif
				                          	</td>
				                        </tr>
				                    @endforeach
